import { Tuple, getTupleType, TupleTypes, createPoint, createVector, equalNumbers, equalTuples, addTuples, subtractTuples, negateTuple, multiplyTuple, divideTuple } from "./tuple"
...
describe("tuple", () => {
    ...
    test("tuples should not be equal", () => {
        const tuple1: Tuple = { x: 1.132, y: 6.231, z: 2.234, w:TupleTypes.Point }
        const tuple2: Tuple = { x: 1.132, y: 6.231, z: 2.234, w:TupleTypes.Vector }
